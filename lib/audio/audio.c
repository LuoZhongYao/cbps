...
{    
    if ( AUDIO->plugin )
    {
        MAKE_AUDIO_MESSAGE( AUDIO_PLUGIN_SET_INPUT_AUDIO_MUTE_MSG ) ; 
            ...
            else
            {
                ...
                */
                ...
                if ( NULL != AUDIO->relay_plugin)
                {
                    ...
                    message->forwarding_sink = AUDIO->forwarding_sink ;
                    message->content_protection = AUDIO->content_protection ;
    
                    MessageSendConditionallyOnTask ( AUDIO->relay_plugin, AUDIO_PLUGIN_START_FORWARDING_MSG, message , (Task *)AudioBusyPtr()) ;
                }
            }
        }
        else
