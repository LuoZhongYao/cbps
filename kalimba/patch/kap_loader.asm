...
.CONST MESSAGE_CLOSE_FILE_ADDRESS   0x803C; //Remove this after it is included in kalimba_messages.h
...
#define FILE_ADDRESS //Use this to toggle between FILE_ADDRESS or FILE_INDEX to open and close kap patch files. 
