...
/*
    ...
    A call to A2dpCodecSetAvailable will return immediately with the status(a2dp_sep_status) of the specified Stream Endpoint.

    A2DP_SEP_UNAVAILABLE = 0x01,   
...
/*
    ...
    A call to A2dpCodecGetAvailable will return immediately with the status(a2dp_sep_status) of the specified Stream Endpoint.
