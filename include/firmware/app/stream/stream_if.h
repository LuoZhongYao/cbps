...
typedef enum
{
    ...
    STREAM_PCM_RX_RATE_DELAY = 0x0113,                      /*!< PCM Rx rate delay - Selects the number of clocks to wait before receive DDS update rate
                                                                 is changed to match the new internal clock frequency. Valid range: 0 to 7 inclusive.*/
    ...
    STREAM_CODEC_SIDETONE_SOURCE_POINT = 0x030f,           /*!< The sidetone source point. Selects source point for ADC data */
    ...
    STREAM_CODEC_ADC_DATA_SOURCE_POINT = 0x0314,                /*!< ADC data source selection. ADC Data source can be selected from 
                                                                either IIR Filter out or Digital Gain filter out */
