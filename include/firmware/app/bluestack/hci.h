...
#define HCI_MAX_ULP_OCF                                   ((hci_op_code_t)0x0022)
...
#define HCI_EV_MASK_ULP_VALID_LO                 ((hci_event_mask_t)0x0000003F)
...
#define HCI_SYNC_TRAIN_SCAN_INTERVAL_MIN          ((uint8_t)0x02)
#define HCI_SYNC_TRAIN_SCAN_INTERVAL_MAX          ((uint16_t)0xFFFE)
#define HCI_SYNC_TRAIN_SCAN_WINDOW_MIN            ((uint8_t)0x22)
#define HCI_SYNC_TRAIN_SCAN_WINDOW_MAX            ((uint16_t)0xFFFE)
#define HCI_SYNC_TRAIN_SCAN_TIMEOUT_MIN           ((uint8_t)0x22)
#define HCI_SYNC_TRAIN_SCAN_TIMEOUT_MAX           ((uint16_t)0xFFFE)
