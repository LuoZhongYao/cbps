...
{
    u16 timeout_s = sinkBleGetConfiguration()->gap_role_switch_timer_s;
...
{
    u16 timeout_s = sinkBleGetConfiguration()->bonding_pairing_period_s;
...
{
    u16 timeout_s = sinkBleGetConfiguration()->bonding_connection_period_s;
...
void sinkBleGapSetSecurityCfm(CL_DM_BLE_SECURITY_CFM_T * cfm)
{
    ...
    u16 cid = GattGetCidForBdaddr(&cfm->taddr);
