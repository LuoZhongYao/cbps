...
{
    uint16 Index = sinkAvrcpGetActiveConnection();  
    uint16 avrcp_volume = theSink.avrcp_link_data->absolute_volume[Index];
    uint16 avrcp_step_change = ((step_change * AVRCP_MAX_ABS_VOL) / (no_of_steps - 1));
...
#define isLessThanMin()                         (((int16)avrcp_volume) < AVRCP_MIN_ABS_VOL)
