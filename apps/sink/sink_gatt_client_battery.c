...
static const u8 bas_ble_advertising_filter[] = {GATT_SERVICE_UUID_BATTERY_SERVICE & 0xFF, GATT_SERVICE_UUID_BATTERY_SERVICE >> 8};
...
*/
static void gattBatteryClientSetCachedLevel(u8 level)
{
...
bool gattBatteryClientAddService(u16 cid, u16 start, u16 end)
{
    ...
    u16 *service = gattClientAddService(connection, sizeof(GBASC));
